    ...
    render: function () {
        ...
        return (
            <div>
                ...
                <input data-order="0" className="rt-numeric-input" style={inputStyle} type="number"/>

                <br/>

                <input data-order="1" className="rt-numeric-checkbox" type="checkbox" checked={this.state.entry1.checked} onChange={this.changeCheckbox}/>
                <select data-order="1" className="rt-numeric-dropdown">
                    <option value="gt">Greater Than</option>
                    <option value="lt">Less Than</option>
                    <option value="eq">Equals</option>
                </select>
                <input data-order="1" className="rt-numeric-input" style={inputStyle} type="number"/>
