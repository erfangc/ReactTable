 ...
 * @param b
 */
function masterSorter(a,b,sectorSorter, detailSorter) {
    // compare sector
    var result = 0;
    if (sectorSorter != null) {
        result = sectorSorter.call(this,a,b);
    } else {
        result = generateSectorKey(a.sectorPath).localeCompare(b.sectorPath);
    }
