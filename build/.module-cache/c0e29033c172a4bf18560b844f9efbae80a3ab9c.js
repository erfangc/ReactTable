        ...
        var headers = this.props.columnDefs.map(function (columnDef) {
            return (
                React.DOM.th({key: columnDef.colTag}, 
                    React.DOM.a({className: "btn-sorter", onClick: self.props.handleSort.bind(null, columnDef)}, columnDef.text || toProper(columnDef.colTag)), 
                    React.DOM.a({className: "btn-link", onClick: self.props.handleRemove.bind(null, columnDef)}, 
