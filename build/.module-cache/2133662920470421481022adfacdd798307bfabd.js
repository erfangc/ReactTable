...
function areAncestorsCollapsed(sectorPaths, collapsedSectorPaths) {
    ...
    for (var i = 0; i < collapsedSectorPaths.length; i++) {
        if (isSubSectorOf(sectorPaths, collapsedSectorPaths[i]))
            result = true;
    }
    return result;
}
 ...
 *
 * its own sector is collapsed, and it is not the summary row of its immediate sector
 *
