...
var Row = React.createClass({displayName: 'Row',
    render: function () {
        ...
        var firstCellStyle = {"padding-left": identLevel * 25 + "px", "border-right-width": "thin",
        ...
        if (this.props.data.isDetail) {
            firstCell = React.DOM.td({style: firstCellStyle, key: this.props.data[firstColTag]}, this.props.data[firstColTag]);
        } else {
            firstCell =
                (
                    React.DOM.td({style: firstCellStyle, key: this.props.data[firstColTag]}, 
        ...
        for (var i = 1; i < this.props.columnDefs.length; i ++) {
            ...
            cells.push(React.DOM.td({style: style, key: this.props.data[columnDef.colTag]}, this.props.data[columnDef.colTag]));
        }
